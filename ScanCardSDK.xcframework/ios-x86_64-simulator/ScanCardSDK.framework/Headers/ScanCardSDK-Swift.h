...
#ifndef SCANCARDSDK_SWIFT_H
#define SCANCARDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ScanCardSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11ScanCardSDK18BaseViewController")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC11ScanCardSDK13QRScannerView")
@interface QRScannerView : UIView
@property (nonatomic, strong) IBInspectable UIImage * _Nullable focusImage;
@property (nonatomic) IBInspectable CGFloat focusImagePadding;
@property (nonatomic) IBInspectable double animationDuration;
@property (nonatomic) IBInspectable BOOL isBlurEffectEnabled;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11ScanCardSDK9ScanMRZVC")
@interface ScanMRZVC : BaseViewController
- (void)viewDidLoad;
...
@interface TakePhotoResultViewController : BaseViewController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
